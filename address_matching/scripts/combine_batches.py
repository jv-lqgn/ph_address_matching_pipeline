...
def default_input_dir() -> Path:
    ...
    return project_root / "data" / "output" / "matched"
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description=(
            "Combine batch matched address files (.xlsx/.xls/.csv), remove "
    ...
    parser.add_argument(
        ...
        help="Folder containing batch matched address files.",
    )
    parser.add_argument(
        "--output",
        type=Path,
        ...
        help=(
            ...
            "Default: <input-dir>/combined_matched_address_pipeline.xlsx"
        ),
    )
